...
const StaffEdit = (props) => {
  ...
  const selectStaffEditState = (state) => state;
  const StaffEditpageData = createSelector(selectStaffEditState, (state) => ({
    item: state.Staffdashboard.item,
    isErrorNotificationVisible: state.Message.isErrorNotificationVisible,
    errorMessage: state.Message.errorMessage,
  }));
  const { isErrorNotificationVisible, errorMessage, item } =
    useSelector(StaffEditpageData);
  ...
  return (
    <div className="page-content">
      <Container fluid>
        <BreadCrumb title="Edit Staff" pageTitle="Staff" />
