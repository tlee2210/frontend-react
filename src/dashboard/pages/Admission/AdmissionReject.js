...
import { GetAllreject } from "../../../slices/Admission/thunk";
...
const rejectTables = (props) => {
  const dispatch = useDispatch();
  const selectrejectState = (state) => state;

  useEffect(() => {
    dispatch(GetAllreject());
  }, []);

  const rejectpageData = createSelector(selectrejectState, (state) => ({
  ...
  document.title = "Admission reject";
      ...
      <Row>
        <Col xs={12}>
          <div className="page-content">
            <Container fluid>
              <BreadCrumb title="Admission reject" pageTitle="Admission" />
              <Row>
                <Col lg={12}>
                  <Card>
                    <CardHeader>
                      <ToastContainer />
                      <h4 className="card-title mb-0">Admission reject</h4>
                    </CardHeader>
                    <CardBody>
                      <div className="listjs-table" id="customerList">
                        <Row className="g-4 mb-3">
                          {/* <Col className="col-sm-auto">
                            <Link to="/dashboard/reject/create">
                              <Button
                                color="success"
...
export default withRouter(rejectTables);
