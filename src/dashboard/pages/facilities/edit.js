...
//edit import
import { GetEditFaculty, UpdateFaculty } from "../../../slices/Faculty/thunk";
//formik
...
const FacultyEdit = (props) => {
  ...
  const FacultyCreatepageData = createSelector(
    ...
    (state) => ({
      ...
      item: state.Facultydashboard.item,
  ...
  const validation = useFormik({
    ...
    initialValues: {
      ...
      Skill: item.skill_learn ? item.skill_learn.split(",") : [],
  ...
  useEffect(() => {
    dispatch(GetEditFaculty(id));
  }, []);

  return (
    <div className="page-content">
      <Container fluid>
        <BreadCrumb title="Edit faculty" pageTitle="faculty" />
...
export default withRouter(FacultyEdit);
