...
import { GetEditDepartment, UpdateDepartment } from "../../../slices/Department/thunk";
//formik
...
const FacultyCreate = (props) => {
  ...
  const FacultyCreatepageData = createSelector(
    ...
    (state) => ({
      ...
      item: state.Departmentdashboard.item,
  ...
  const validation = useFormik({
    ...
    onSubmit: (values) => {
      ...
      dispatch(UpdateDepartment(formData, props.router.navigate));
  ...
  return (
    <div className="page-content">
      <Container fluid>
        <BreadCrumb title="Edit department" pageTitle="department" />
