...
const MainPage = () => {
  ...
  return (
    <Card>
      <CardBody>
        <Nav tabs className="fs-5 nav nav-tabs nav-justified nav-border-top nav-border-top-success mb-3">
          <NavItem>
          ...
          <NavItem>
            <NavLink style={{ cursor: "pointer" }} className={classnames({ active: topBorderTab === "3", })} onClick={() => { topBordertoggle("3"); }} >
              <i className="ri-question-answer-line align-middle me-1"></i>Study structure
            </NavLink>
          </NavItem>
          <NavItem>
            <NavLink style={{ cursor: "pointer" }} className={classnames({ active: topBorderTab === "4", })} onClick={() => { topBordertoggle("4"); }} >
              <i className="ri-home-5-line align-middle me-1"></i> Fees & Scholarships
            </NavLink>
          </NavItem>
          <NavItem>
            <NavLink style={{ cursor: "pointer" }} className={classnames({ active: topBorderTab === "5", })} onClick={() => { topBordertoggle("5"); }} >
        ...
        <TabContent activeTab={topBorderTab} className="text-muted">
            ...
            <div className='OverViewContent' style={{ paddingTop: 50 }}>
              ...
              <div className="row" style={{ paddingBottom: 70 }}>
                ...
                <div className="col-sm-8">
                  ...
                  <a href="#" className="course-guide-link-overview-Graduated text-Entry-requiment">
                  ...
                  <blockquote className="blockquote custom-blockquote blockquote-outline blockquote-success rounded mb-0">
                    <p className="text-body mb-2 fw-bold">Thinking about applying for 2024?</p>
                    ...
                    <a href="#" className="register-link-overview-Graduated" style={{ color: 'red' }}>
                      Register now
                    </a>
                  </blockquote>
              ...
              <div className="row" >
                ...
                <div className="col-sm-4">
                  <div className='overview-container-overview-Graduated'>
                    <h2 className='overview-title-overview-Graduated' >Your industry experience</h2>
                  </div>
                </div>
                {/* Study Expo Container */}
                <div className="col-sm-8">
                  <div >
                    ...
                    <a href="#" className="course-handbook-link-overview-Graduated" style={{ color: 'red' }}>
          ...
          <TabPane tabId="2" id="nav-border-justified-profile">
            <div className='EntryRequirementsContent' style={{ paddingTop: 50 }}>
              ...
              <div className="row">
                {/* Title */}
                <div className="col-sm-4">
                  <h2 className="overview-title-overview-Graduated">Qualifications</h2>
                </div>
                {/* Content */}
                <div className="col-sm-8">
              ...
              <div className="row">
                {/* Title */}
                <div className="col-sm-4">
                  <h2 className="overview-title-overview-Graduated">Course prerequisites</h2>
                </div>
                {/* Content */}
                <div className="col-sm-8">
                  <ul className="text-Entry-requiment">
                  ...
                  <blockquote className="blockquote custom-blockquote blockquote-outline blockquote-success rounded mb-0">
                    <p className="text-body mb-2 fw-bold">Admission requirements</p>
                    <p className="study-expo-text-overview-Graduated ">
                      Meeting the minimum entry requirements for the course does not guarantee an offer of a place. See admission requirements for general information about the admission process.
                    </p>
                    <a href="#" className="text-Entry-requiment" style={{ color: 'red' }}>
              ...
              <div className="row" style={{ paddingTop: 70 }}>
                {/* Title */}
                <div className="col-sm-4">
                  <h2 className="overview-title-overview-Graduated">Credit transfer</h2>
                </div>
                {/* Content */}
                <div className="col-sm-8">
              ...
              <div className="row" style={{ paddingTop: 70 }}>
                {/* Title */}
                <div className="col-sm-4">
                  <h2 className="overview-title-overview-Graduated">Recognition of prior learning</h2>
                </div>
                {/* Content */}
                <div className="col-sm-8">
                  <p className="text-Entry-requiment">
                  ...
                  <p className='text-Entry-requiment cursor-pointer' style={{ color: 'red' }}>Learn more about RPL</p>
                </div>
              </div>
            </div>
          </TabPane>
          ...
          <TabPane tabId="3" id="nav-border-justified-messages">
            <div className='StudyStructureContent' style={{ paddingTop: 50 }}>
                ...
                <div className="col-sm-8">
                  ...
                  <div className="credit-points-container">
                    <div className="credit-points-header">
                      <p style={{ textAlign: 'left' }}>Successful completion of the Bachelor of Business / Bachelor of Applied Innovation requires students to complete units of study to the value of 400 credit points. All units of study are valued at 12.5 credit points unless otherwise stated.</p>
                    </div>
                    <div className="credit-points-container">
                      {/* Credit Point Info */}
              ...
              <div className='row' style={{ paddingTop: 70, paddingBottom: 30 }}>
                <div className="col-sm-4">
                ...
                <div className="col-sm-8">
                  ...
                  <p style={{ paddingTop: 20 }} className="text-Entry-requiment">
                  ...
                  <blockquote className="blockquote custom-blockquote blockquote-outline blockquote-success rounded mb-0">
                    <p className="text-body mb-2 fw-bold">Want to learn more about the available majors?</p>
                    <p className="study-expo-text-overview-Graduated">
                  ...
                  <div className="bachelor-container" style={{ paddingTop: 30 }}>
          ...
          <TabPane tabId="4" id="nav-border-justified-messages">
            <div style={{ paddingTop: 0 }}>
              <div className='FeesScholarshipsContent' style={{ paddingTop: 50 }}>
                ...
                <div className='row'>
                  ...
                  <div className='col-sm-8'>
                    ...
                    <blockquote className="blockquote custom-blockquote blockquote-outline blockquote-success rounded mb-0">
                      <p className="text-body mb-2 fw-bold">Fees are estimates only</p>
                      <p className="study-expo-text-overview-Graduated">
                ...
                <div className='row' style={{ paddingTop: 70 }}>
                  <div className='col-sm-4'>
                    <h2 className='verview-title-overview-Graduated' >How do I pay my fees?</h2>
                  </div>
                  <div className='col-sm-8'>
                    <p className="overview-text-overview-Graduated">
                ...
                <div className='row' style={{ paddingTop: 70 }}>
                  <div className='col-sm-4'>
                    <h2 className='verview-title-overview-Graduated' >Eligibility for HECS-HELP</h2>
                  </div>
                  <div className='col-sm-8'>
                    <div >
                      <ul className="list-unstyled">
                        <li className="overview-text-overview-Graduated">You are eligible for a HECS-HELP loan if you have been offered a Commonwealth Supported Place (CSP) for an undergraduate degree at Swinburne or a UniLink course, and you:</li>
                        <ul>
              ...
              <div className='row' style={{ paddingTop: 70 }}>
                ...
                <div className='col-sm-8'>
                  <p className='study-expo-text-overview-Graduated'>This funding serves to improve the student experience at Swinburne. You may use many or just some of the services and amenities that the fee provides.</p>
              ...
              <div className='row' style={{ paddingTop: 70 }}>
                <div className='col-sm-4'>
                  <h2 className='verview-title-overview-Graduated' >Professional placement fees</h2>
                </div>
                <div className='col-sm-8'>
                  <p className="overview-text-overview-Graduated">
              ...
              <div className='row'>
                ...
                <div className='col-sm-2 '>
                  <Card className="card-body" style={{
                    ...
                    <p className="card-text text-muted text-center">BB-BUSAIN1</p>
              ...
              <div className='row'>
                ...
                <div className='col-sm-2 '>
                  <Card className="card-body" style={{
                    ...
                    <h4 className="card-title text-center">VTAC Code (CSP)</h4>
                    <p className="card-text text-muted text-center">3400212531</p>
                    <button className="apply-button-how-to-apply">Apply directly</button>
                  </Card>
                </div>
              </div>
