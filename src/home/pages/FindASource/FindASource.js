      ...
      <ParticlesAuth>
        <header className="header-container-graduate-Header">
          <div className="header-content-graduate-Header">
            ...
            <p className='mt-3 fs-6'>Don't just graduate, innovate. The Bachelor of Applied Innovation aims to make you think like an innovator, explore bold ideas, and create unprecedented solutions.</p>
            <Button color='danger mt-3' outline>Find A Source</Button>
          </div>
        </header>
        ...
        <div className='row'>
          ...
          <div className='col-sm-8'>
            ...
            <h2 className='fw-bold'>What is a Bachelor of Applied Innovation?</h2>
          ...
          <div className="cta-container">
            <div className="cta-content">
              ...
              <Button to="/about-us" className='btn-soft-dark btn-border'>
                <i className='mdi mdi-information-outline' style={{ paddingRight: 3 }}></i>
                Contact Us
                <i className='mdi mdi-arrow-right' style={{ paddingLeft: 15 }}></i>
              </Button>
            </div>
          </div>
        </div>
