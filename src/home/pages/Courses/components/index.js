        ...
        <div className='index ' >
            ...
            <div className="row pt-3 pb-5 w-100" >
                ...
                <div className='col-sm-8'>
                    <h4 className='fs-1'>
                        Future-ready learning</h4>
                    <div>
                        <p>Students come first at Swinburne. Our courses are designed with your future in mind. Swinburne offers high-quality teaching, opportunities to engage with industry, state-of-the-art facilities and flexible study options.</p>
                    </div>
                </div>
            </div>

            {/* Search */}
            <div className="search-container-source-page" style={{ paddingBottom: 100 }}>
            ...
            <div className="row  w-100" style={{ paddingBottom: 50 }} >
                ...
                <div className='col-sm-8'>
                    <h4 className='fs-1'>
                        Study your way with our flexible options</h4>
                    <div>
                        <p>We understand that you may have to organise your studies around family and other commitments. That's why we offer flexible course options to allow you to study part-time, over the weekends, at nights, online or even out of the country. Learn more about the study options we offer to suit your lifestyle.</p>
                        <a href='#' style={{ color: 'red' }}>Learn more about course delivery options</a>
                    </div>
                </div>
            </div>
